...
//   RDY1/SLWR     <-->  GND
//------------------------------------------------------------------------------
//FIFOPINPOLAR=0x00; no polartiy reversal
// OLD OLD OLD OLD OLD OLD OLD OLD OLD OLD OLD OLD OLD OLD OLD OLD OLD OLD 
...
//   PA4/FIFOADR0  <-->  GND
//   PA5/FIFOADR1  <--> +3V3
//   PA6/PKTEND    <-->  GND, probably not needed
//   RDY0/SLRD     <-->  GND
//   RDY1/SLWR     <-->  GND
//------------------------------------------------------------------------------
// FIFOPINPOLAR, Slave FIFO Interface Pins Polarity
// b7 b6 b5 b4 b3 b2 b1  b0
// 0 0 PKTEND SLOE SLRD SLWR EF FF
// 0 0 1 1 1 0 0 0
// Leave SLWR active low, external bus is writing into fx2
// Disable PKTEND SLOE and SLRD
//FIFOPINPOLAR=0x38; // necessary polarity reversal
// NEW NEW NEW NEW NEW NEW NEW NEW NEW NEW NEW NEW NEW NEW NEW NEW NEW NEW
