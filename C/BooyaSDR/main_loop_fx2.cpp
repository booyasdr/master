...
{
    const int callShowStatsRate = round(2*32*QUEUE_SIZE*global.fs/64/1000/1000);
    ...
    gettimeofday(&start_tv,NULL);
     ...
     for (tsub = 0; tsub < nusbbuf-1; tsub++) {
        ...
        ret = usb_submit_async(context[tsub],(char *) p, global.transferSize);
    }
...
/////////////////////////   Start Main Loop    //////////////////////////////////////
    while( true)
    {
        ret = usb_submit_async(context[tsub],( char *) buffers[tsub],  global.transferSize);
        tsub++;
