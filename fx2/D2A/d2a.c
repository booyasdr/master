...
//   PA4/FIFOADR0  <-->  GND
//   PA5/FIFOADR1  <-->  GND, address EP2
//   RDY0/SLRD     <--> GND, RDY1 on the board
//   RDY1/SLWR     <--> GND, RDY0 on the board
//   PA6           <--> GND, added by WW
//------------------------------------------------------------------------------
// Set z[the IO pins on port A:
...
This bit selects the polarity of the EF FIFO output pin. 0 selects the polarity shown in the
data sheet (active low). 1 selects active high.
Bit 0 FF Full Flag Polarity
This bit selects the polarity of the FF FIFO output pin. 0 selects the polarity shown in the
data sheet (active low). 1 selects active high.
 AJ AJ AJ AJ AJ AJ AJ AJ AJ AJ AJ AJ AJ AJ AJ AJ AJ AJ AJ AJ AJ AJ AJ AJ AJ
*/
// USE with	FIFOPINPOLAR=0x24; // 0 0 1 0 0 1 0 0, for D2A
// Option 2 for EP2 AUTO OUT
...
static void Initialize(void)
{
	...
	xdata char *cfg_data=(xdata char*)0x1004;
    char cfg_data_ok;
	char EP2FIFOPOLARITY;
...
//	char cfg_data_ok = (cfg_data[0]==0x12U || cfg_data[0]==0x21U);
	...
	EP4CFG=0x00U;  SYNCDELAY;
	EP8CFG=0x00U;  SYNCDELAY;
	EP6FIFOCFG=0x00U;  SYNCDELAY;
	EP2FIFOCFG=0x00U;  SYNCDELAY;
	EP8FIFOCFG=0x00U;  SYNCDELAY;
	EP4FIFOCFG=0x00U;  SYNCDELAY;
	OEA=0x00U;  SYNCDELAY;
	OED=0x00U;  SYNCDELAY;
...
//	FIFOPINPOLAR=0x20; // 0 0 0 0 0 0 0 0
	FIFOPINPOLAR=EP2FIFOPOLARITY; // 0 0 0 0 0 0 0 0
	SYNCDELAY;
