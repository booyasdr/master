...
; This file was generated Sun Nov 24 08:15:28 2013
;--------------------------------------------------------
	.module hello
...
;--------------------------------------------------------
	.area DSEG    (DATA)
_SetUpBufToTransfer_serial_1_1:
	.ds 1
;--------------------------------------------------------
; overlayable items in internal ram 
;--------------------------------------------------------
	.area	OSEG    (OVR,DATA)
_SetUpBufToTransfer_len_1_1:
	.ds 1
...
;	hello.c:59: while(*src)
	...
	mov	ar1,r6
	mov	ar2,r7
	mov	_SetUpBufToTransfer_len_1_1,#0x00
00101$:
	mov	dpl,r3
	mov	dph,r4
	mov	b,r5
...
00110$:
	...
	mov	r2,dph
;	hello.c:62: ++len;
	inc	_SetUpBufToTransfer_len_1_1
	sjmp	00101$
00103$:
;	hello.c:65: *dest++='(';                ++len;
	mov	dpl,r1
	...
	addc	a,r2
	mov	r7,a
	mov	a,_SetUpBufToTransfer_len_1_1
	inc	a
	mov	r5,a
;	hello.c:66: *dest++='0'+serial/100;     ++len;
	mov	b,#0x64
	mov	a,_SetUpBufToTransfer_serial_1_1
	div	ab
	add	a,#0x30
	mov	dpl,r6
	mov	dph,r7
...
;	hello.c:69: *dest++=')';                ++len;
	...
	inc	r5
;	hello.c:70: ++serial;
	inc	_SetUpBufToTransfer_serial_1_1
