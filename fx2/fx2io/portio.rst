   ...
   006E 90 E6 01            615 	mov	dptr,#_IFCONFIG
   0071 E4                  616 	clr	a
   0072 F0                  617 	movx	@dptr,a
   ...
   0077 90 E6 0B            624 	mov	dptr,#_REVCTL
   007A 74 03               625 	mov	a,#0x03
   007C F0                  626 	movx	@dptr,a
   ...
   0081 90 E6 09            633 	mov	dptr,#_FIFOPINPOLAR
   0084 E4                  634 	clr	a
   0085 F0                  635 	movx	@dptr,a
   ...
   008A 90 E6 70            642 	mov	dptr,#_PORTACFG
   008D E4                  643 	clr	a
   008E F0                  644 	movx	@dptr,a
   ...
   0093 75 B2 00            651 	mov	_OEA,#0x00
                            652 ;	portio.c:94: OEB = 0x00;
   0096 75 B3 00            653 	mov	_OEB,#0x00
                            654 ;	portio.c:95: OEC = 0x00;
   0099 75 B4 00            655 	mov	_OEC,#0x00
                            656 ;	portio.c:96: OED = 0x00;
   009C 75 B5 00            657 	mov	_OED,#0x00
                            658 ;	portio.c:98: OEB = 0xFF;
   009F 75 B3 FF            659 	mov	_OEB,#0xFF
                            660 ;	portio.c:99: OED = 0xFF;
   00A2 75 B5 FF            661 	mov	_OED,#0xFF
   00A5 22                  662 	ret
                            663 ;------------------------------------------------------------
   ...
   00A6 12 00 64            675 	lcall	_Initialize
                            676 ;	portio.c:134: for(n = 0; n < 0x0003; n ++ )
   00A9                     677 00125$:
   00A9 7E 00               678 	mov	r6,#0x00
   00AB 7F 00               679 	mov	r7,#0x00
   00AD                     680 00105$:
   00AD C3                  681 	clr	c
   00AE EE                  682 	mov	a,r6
   00AF 94 03               683 	subb	a,#0x03
   00B1 EF                  684 	mov	a,r7
   00B2 94 00               685 	subb	a,#0x00
   00B4 50 21               686 	jnc	00108$
                            687 ;	portio.c:135: for(m = 0; m < 0xFFFF; m ++ ) {
   00B6 7C 00               688 	mov	r4,#0x00
   00B8 7D 00               689 	mov	r5,#0x00
   00BA                     690 00101$:
   00BA C3                  691 	clr	c
   00BB EC                  692 	mov	a,r4
   00BC 94 FF               693 	subb	a,#0xFF
   00BE ED                  694 	mov	a,r5
   00BF 94 FF               695 	subb	a,#0xFF
   00C1 50 0D               696 	jnc	00107$
                            697 ;	portio.c:136: IOB = 0xFF;
   00C3 75 90 FF            698 	mov	_IOB,#0xFF
                            699 ;	portio.c:137: IOD = 0xFF; }
   00C6 75 B0 FF            700 	mov	_IOD,#0xFF
                            701 ;	portio.c:135: for(m = 0; m < 0xFFFF; m ++ ) {
   00C9 0C                  702 	inc	r4
   00CA BC 00 ED            703 	cjne	r4,#0x00,00101$
   00CD 0D                  704 	inc	r5
   00CE 80 EA               705 	sjmp	00101$
   00D0                     706 00107$:
                            707 ;	portio.c:134: for(n = 0; n < 0x0003; n ++ )
   00D0 0E                  708 	inc	r6
   00D1 BE 00 D9            709 	cjne	r6,#0x00,00105$
   00D4 0F                  710 	inc	r7
   00D5 80 D6               711 	sjmp	00105$
   00D7                     712 00108$:
                            713 ;	portio.c:138: for(n = 0; n < 0x0003; n ++ )
   00D7 7E 00               714 	mov	r6,#0x00
   00D9 7F 00               715 	mov	r7,#0x00
   00DB                     716 00113$:
   00DB C3                  717 	clr	c
   00DC EE                  718 	mov	a,r6
   00DD 94 03               719 	subb	a,#0x03
   00DF EF                  720 	mov	a,r7
   00E0 94 00               721 	subb	a,#0x00
   00E2 50 C5               722 	jnc	00125$
                            723 ;	portio.c:139: for(m = 0; m < 0xFFFF; m ++ ) {
   00E4 7C 00               724 	mov	r4,#0x00
   00E6 7D 00               725 	mov	r5,#0x00
   00E8                     726 00109$:
   00E8 C3                  727 	clr	c
   00E9 EC                  728 	mov	a,r4
   00EA 94 FF               729 	subb	a,#0xFF
   00EC ED                  730 	mov	a,r5
   00ED 94 FF               731 	subb	a,#0xFF
   00EF 50 0D               732 	jnc	00115$
                            733 ;	portio.c:140: IOB = 0x00;
   00F1 75 90 00            734 	mov	_IOB,#0x00
                            735 ;	portio.c:141: IOD = 0x00; }
   00F4 75 B0 00            736 	mov	_IOD,#0x00
                            737 ;	portio.c:139: for(m = 0; m < 0xFFFF; m ++ ) {
   00F7 0C                  738 	inc	r4
   00F8 BC 00 ED            739 	cjne	r4,#0x00,00109$
   00FB 0D                  740 	inc	r5
   00FC 80 EA               741 	sjmp	00109$
   00FE                     742 00115$:
                            743 ;	portio.c:138: for(n = 0; n < 0x0003; n ++ )
   00FE 0E                  744 	inc	r6
   00FF BE 00 D9            745 	cjne	r6,#0x00,00113$
   0102 0F                  746 	inc	r7
   0103 80 D6               747 	sjmp	00113$
                            748 	.area CSEG    (CODE)
                            749 	.area CONST   (CODE)
                            750 	.area XINIT   (CODE)
