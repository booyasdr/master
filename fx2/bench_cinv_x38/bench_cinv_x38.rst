                              ...
                              4 ; This file was generated Tue Mar 08 20:13:48 2016
                              5 ;--------------------------------------------------------
                              6 	.module bench_cinv_x38
   ...
   0006 80 FE               584 	sjmp .
                            ...
                            591 ;------------------------------------------------------------
                            592 ;	bench_cinv_x38.c:61: static void Initialize(void)
                            593 ;	-----------------------------------------
   ...
   0064                     596 _Initialize:
                    ...
                    0001    603 	ar1 = 0x01
                    0000    604 	ar0 = 0x00
                            605 ;	bench_cinv_x38.c:63: CPUCS = 0x12;  // 48MHz, output to CLKOUT signal enabled.
   0064 90 E6 00            606 	mov	dptr,#_CPUCS
   0067 74 12               607 	mov	a,#0x12
   0069 F0                  608 	movx	@dptr,a
                            609 ;	bench_cinv_x38.c:67: IFCONFIG = 0xc3;
   006A 90 E6 01            610 	mov	dptr,#_IFCONFIG
   006D 74 C3               611 	mov	a,#0xC3
   006F F0                  612 	movx	@dptr,a
                            613 ;	bench_cinv_x38.c:68: SYNCDELAY;
   0070 00                  614 	nop 
   0071 00                  615 	nop 
   0072 00                  616 	nop 
   0073 00                  617 	nop 
                            618 ;	bench_cinv_x38.c:70: IFCONFIG = 0x53;
   0074 90 E6 01            619 	mov	dptr,#_IFCONFIG
   0077 74 53               620 	mov	a,#0x53
   0079 F0                  621 	movx	@dptr,a
                            622 ;	bench_cinv_x38.c:71: SYNCDELAY;
   007A 00                  623 	nop 
   007B 00                  624 	nop 
   007C 00                  625 	nop 
   007D 00                  626 	nop 
                            627 ;	bench_cinv_x38.c:76: REVCTL = 0x03;   // See TRM...
   007E 90 E6 0B            628 	mov	dptr,#_REVCTL
   0081 74 03               629 	mov	a,#0x03
   0083 F0                  630 	movx	@dptr,a
                            631 ;	bench_cinv_x38.c:77: SYNCDELAY;
   0084 00                  632 	nop 
   0085 00                  633 	nop 
   0086 00                  634 	nop 
   0087 00                  635 	nop 
                            636 ;	bench_cinv_x38.c:80: EP6CFG = 0xe0;
   0088 90 E6 14            637 	mov	dptr,#_EP6CFG
   008B 74 E0               638 	mov	a,#0xE0
   008D F0                  639 	movx	@dptr,a
                            640 ;	bench_cinv_x38.c:82: SYNCDELAY;
   008E 00                  641 	nop 
   008F 00                  642 	nop 
   0090 00                  643 	nop 
   0091 00                  644 	nop 
                            645 ;	bench_cinv_x38.c:84: FIFORESET = 0x80;  SYNCDELAY;  // NAK all requests from host.
   ...
   009A 00                  651 	nop 
   009B 00                  652 	nop 
                            653 ;	bench_cinv_x38.c:85: FIFORESET = 0x82;  SYNCDELAY;  // Reset individual EP (2,4,6,8)
   ...
   00A4 00                  659 	nop 
   00A5 00                  660 	nop 
                            661 ;	bench_cinv_x38.c:86: FIFORESET = 0x84;  SYNCDELAY;
   ...
   00AE 00                  667 	nop 
   00AF 00                  668 	nop 
                            669 ;	bench_cinv_x38.c:87: FIFORESET = 0x86;  SYNCDELAY;
   ...
   00B8 00                  675 	nop 
   00B9 00                  676 	nop 
                            677 ;	bench_cinv_x38.c:88: FIFORESET = 0x88;  SYNCDELAY;
   ...
   00C2 00                  683 	nop 
   00C3 00                  684 	nop 
                            685 ;	bench_cinv_x38.c:89: FIFORESET = 0x00;  SYNCDELAY;  // Resume normal operation.
   ...
   00CB 00                  691 	nop 
   00CC 00                  692 	nop 
                            693 ;	bench_cinv_x38.c:92: EP6FIFOCFG = 0x09;
   00CD 90 E6 1A            694 	mov	dptr,#_EP6FIFOCFG
   00D0 74 09               695 	mov	a,#0x09
   00D2 F0                  696 	movx	@dptr,a
                            697 ;	bench_cinv_x38.c:94: SYNCDELAY;
   00D3 00                  698 	nop 
   00D4 00                  699 	nop 
   00D5 00                  700 	nop 
   00D6 00                  701 	nop 
                            702 ;	bench_cinv_x38.c:97: PORTACFG = 0x00;
   00D7 90 E6 70            703 	mov	dptr,#_PORTACFG
   00DA E4                  704 	clr	a
   00DB F0                  705 	movx	@dptr,a
                            706 ;	bench_cinv_x38.c:98: SYNCDELAY; // maybe not needed
   00DC 00                  707 	nop 
   00DD 00                  708 	nop 
   00DE 00                  709 	nop 
   00DF 00                  710 	nop 
                            711 ;	bench_cinv_x38.c:101: FIFOPINPOLAR=0x38;
   00E0 90 E6 09            712 	mov	dptr,#_FIFOPINPOLAR
   00E3 74 38               713 	mov	a,#0x38
   00E5 F0                  714 	movx	@dptr,a
                            715 ;	bench_cinv_x38.c:102: SYNCDELAY;
   00E6 00                  716 	nop 
   00E7 00                  717 	nop 
   00E8 00                  718 	nop 
   00E9 00                  719 	nop 
                            720 ;	bench_cinv_x38.c:106: EP6AUTOINLENH = 0x02; // MSB
   00EA 90 E6 24            721 	mov	dptr,#_EP6AUTOINLENH
   00ED 74 02               722 	mov	a,#0x02
   00EF F0                  723 	movx	@dptr,a
                            724 ;	bench_cinv_x38.c:108: SYNCDELAY;
   00F0 00                  725 	nop 
   00F1 00                  726 	nop 
   00F2 00                  727 	nop 
   00F3 00                  728 	nop 
                            729 ;	bench_cinv_x38.c:109: EP6AUTOINLENL = 0x00; // LSB
   00F4 90 E6 25            730 	mov	dptr,#_EP6AUTOINLENL
   00F7 E4                  731 	clr	a
   00F8 F0                  732 	movx	@dptr,a
                            733 ;	bench_cinv_x38.c:111: SYNCDELAY;
   00F9 00                  734 	nop 
   00FA 00                  735 	nop 
   00FB 00                  736 	nop 
   00FC 00                  737 	nop 
   00FD 22                  738 	ret
                            ...
                            741 ;------------------------------------------------------------
                            742 ;	bench_cinv_x38.c:115: void main()
                            743 ;	-----------------------------------------
                            744 ;	 function main
                            745 ;	-----------------------------------------
   00FE                     746 _main:
                            747 ;	bench_cinv_x38.c:117: Initialize();
   00FE 12 00 64            748 	lcall	_Initialize
   0101                     749 00102$:
   0101 80 FE               750 	sjmp	00102$
                            751 	.area CSEG    (CODE)
                            752 	.area CONST   (CODE)
                            753 	.area XINIT   (CODE)
