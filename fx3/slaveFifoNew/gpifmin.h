/*
 * Project Name: multimin.cyfx
 * Time : 01/25/2015 08:48:46
 * Device Type: FX3
 * Project Type: GPIF2
 *
 *
...
#ifndef _INCLUDED_GPIFMIN_
#define _INCLUDED_GPIFMIN_
#include "cyu3types.h"
#include "cyu3gpif.h"
...
CyU3PGpifWaveData CyFxGpifWavedata[]  = {
    {{0x1E739E01,0x00000100,0x800000A0},{0x00000000,0x00000000,0x00000000}},
    {{0x2E729E02,0x20010006,0x80000060},{0x00000000,0x00000000,0x00000000}},
    {{0x1E739E01,0x00000100,0x800000A0},{0x1E739303,0x24000100,0x80000090}}
};
...
uint32_t CyFxGpifRegValue[]  = {
    ...
    0x00000020,  /*  CY_U3P_PIB_GPIF_INTR_MASK */
    ...
    0x00000170,  /*  CY_U3P_PIB_GPIF_CTRL_BUS_POLARITY */
    ...
    0x00001FFF,  /*  CY_U3P_PIB_GPIF_ADDR_COUNT_LIMIT */
    ...
    0x00001FFF,  /*  CY_U3P_PIB_GPIF_DATA_COUNT_LIMIT */
