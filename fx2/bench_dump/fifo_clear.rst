                              ...
                              4 ; This file was generated Wed Jun 13 20:23:35 2012
                              5 ;--------------------------------------------------------
                              6 	.module fifo_clear
   ...
   0006 80 FE               585 	sjmp .
                            ...
                            592 ;------------------------------------------------------------
                            593 ;	fifo_clear.c:38: static void Initialize(void)
                            594 ;	-----------------------------------------
                            595 ;	 function Initialize
                            596 ;	-----------------------------------------
   0064                     597 _Initialize:
                    0007    598 	ar7 = 0x07
                    0006    599 	ar6 = 0x06
                    0005    600 	ar5 = 0x05
                    0004    601 	ar4 = 0x04
                    ...
                    0001    604 	ar1 = 0x01
                    0000    605 	ar0 = 0x00
                            606 ;	fifo_clear.c:41: CPUCS = 0x12;  // 48MHz, output to CLKOUT signal enabled.
   0064 90 E6 00            607 	mov	dptr,#_CPUCS
   0067 74 12               608 	mov	a,#0x12
   0069 F0                  609 	movx	@dptr,a
                            610 ;	fifo_clear.c:45: IFCONFIG = 0xc3;
   006A 90 E6 01            611 	mov	dptr,#_IFCONFIG
   006D 74 C3               612 	mov	a,#0xC3
   006F F0                  613 	movx	@dptr,a
                            614 ;	fifo_clear.c:46: SYNCDELAY;
   0070 00                  615 	 nop 
   0071 00                  616 	 nop 
   0072 00                  617 	 nop 
   0073 00                  618 	 nop 
                            619 ;	fifo_clear.c:48: IFCONFIG = 0x53;
   0074 90 E6 01            620 	mov	dptr,#_IFCONFIG
   0077 74 53               621 	mov	a,#0x53
   0079 F0                  622 	movx	@dptr,a
                            623 ;	fifo_clear.c:49: SYNCDELAY;
   007A 00                  624 	 nop 
   007B 00                  625 	 nop 
   007C 00                  626 	 nop 
   007D 00                  627 	 nop 
                            628 ;	fifo_clear.c:51: IFCONFIG = 0x43;
   007E 90 E6 01            629 	mov	dptr,#_IFCONFIG
   0081 74 43               630 	mov	a,#0x43
   0083 F0                  631 	movx	@dptr,a
                            632 ;	fifo_clear.c:52: SYNCDELAY;
   0084 00                  633 	 nop 
   0085 00                  634 	 nop 
   0086 00                  635 	 nop 
   0087 00                  636 	 nop 
                            637 ;	fifo_clear.c:54: REVCTL = 0x03;   // See TRM...
   0088 90 E6 0B            638 	mov	dptr,#_REVCTL
   008B 74 03               639 	mov	a,#0x03
   008D F0                  640 	movx	@dptr,a
                            641 ;	fifo_clear.c:55: SYNCDELAY;
   008E 00                  642 	 nop 
   008F 00                  643 	 nop 
   0090 00                  644 	 nop 
   0091 00                  645 	 nop 
                            646 ;	fifo_clear.c:62: FIFORESET = 0x80;  SYNCDELAY;  // NAK all requests from host.
   0092 90 E6 04            647 	mov	dptr,#_FIFORESET
   0095 74 80               648 	mov	a,#0x80
   0097 F0                  649 	movx	@dptr,a
   0098 00                  650 	 nop 
   0099 00                  651 	 nop 
   009A 00                  652 	 nop 
   009B 00                  653 	 nop 
                            654 ;	fifo_clear.c:63: FIFORESET = 0x82;  SYNCDELAY;  // Reset individual EP (2,4,6,8)
   009C 90 E6 04            655 	mov	dptr,#_FIFORESET
   009F 74 82               656 	mov	a,#0x82
   00A1 F0                  657 	movx	@dptr,a
   00A2 00                  658 	 nop 
   00A3 00                  659 	 nop 
   00A4 00                  660 	 nop 
   00A5 00                  661 	 nop 
                            662 ;	fifo_clear.c:64: FIFORESET = 0x84;  SYNCDELAY;
   00A6 90 E6 04            663 	mov	dptr,#_FIFORESET
   00A9 74 84               664 	mov	a,#0x84
   00AB F0                  665 	movx	@dptr,a
   00AC 00                  666 	 nop 
   00AD 00                  667 	 nop 
   00AE 00                  668 	 nop 
   00AF 00                  669 	 nop 
                            670 ;	fifo_clear.c:65: FIFORESET = 0x86;  SYNCDELAY;
   00B0 90 E6 04            671 	mov	dptr,#_FIFORESET
   00B3 74 86               672 	mov	a,#0x86
   00B5 F0                  673 	movx	@dptr,a
   00B6 00                  674 	 nop 
   00B7 00                  675 	 nop 
   00B8 00                  676 	 nop 
   00B9 00                  677 	 nop 
                            678 ;	fifo_clear.c:66: FIFORESET = 0x88;  SYNCDELAY;
   00BA 90 E6 04            679 	mov	dptr,#_FIFORESET
   00BD 74 88               680 	mov	a,#0x88
   00BF F0                  681 	movx	@dptr,a
   00C0 00                  682 	 nop 
   00C1 00                  683 	 nop 
   00C2 00                  684 	 nop 
   00C3 00                  685 	 nop 
                            686 ;	fifo_clear.c:67: FIFORESET = 0x00;  SYNCDELAY;  // Resume normal operation.
   00C4 90 E6 04            687 	mov	dptr,#_FIFORESET
   00C7 E4                  688 	clr	a
   00C8 F0                  689 	movx	@dptr,a
   00C9 00                  690 	 nop 
   00CA 00                  691 	 nop 
   00CB 00                  692 	 nop 
   00CC 00                  693 	 nop 
   00CD 22                  694 	ret
                            ...
                            697 ;------------------------------------------------------------
                            698 ;dest                      Allocated to registers r6 r7 
                            699 ;src                       Allocated to registers r4 r5 
                            700 ;x                         Allocated to registers 
                            701 ;i                         Allocated to registers r2 r3 r4 r5 
                            702 ;------------------------------------------------------------
                            703 ;	fifo_clear.c:95: void main()
                            704 ;	-----------------------------------------
                            705 ;	 function main
                            706 ;	-----------------------------------------
   00CE                     707 _main:
                            708 ;	fifo_clear.c:102: Initialize();
   00CE 12 00 64            709 	lcall	_Initialize
                            710 ;	fifo_clear.c:103: for(dest = 0x3000;dest <= 0x3fff;dest++) *dest = '\0';
   00D1 7E 00               711 	mov	r6,#0x00
   00D3 7F 30               712 	mov	r7,#0x30
   00D5                     713 00101$:
   00D5 8E 04               714 	mov	ar4,r6
   00D7 8F 05               715 	mov	ar5,r7
   00D9 C3                  716 	clr	c
   00DA 74 FF               717 	mov	a,#0xFF
   00DC 9C                  718 	subb	a,r4
   00DD 74 3F               719 	mov	a,#0x3F
   00DF 9D                  720 	subb	a,r5
   00E0 40 0D               721 	jc	00104$
   00E2 8E 82               722 	mov	dpl,r6
   00E4 8F 83               723 	mov	dph,r7
   00E6 E4                  724 	clr	a
   00E7 F0                  725 	movx	@dptr,a
   00E8 A3                  726 	inc	dptr
   00E9 AE 82               727 	mov	r6,dpl
   00EB AF 83               728 	mov	r7,dph
   00ED 80 E6               729 	sjmp	00101$
   00EF                     730 00104$:
                            731 ;	fifo_clear.c:112: for(dest =0xf000,i=0; i <= 0x10000 ;dest++,i++) *dest = x;
   00EF 7E 00               732 	mov	r6,#0x00
   00F1 7F F0               733 	mov	r7,#0xF0
   00F3 7A 00               734 	mov	r2,#0x00
   00F5 7B 00               735 	mov	r3,#0x00
   00F7 7C 00               736 	mov	r4,#0x00
   00F9 7D 00               737 	mov	r5,#0x00
   00FB                     738 00105$:
   00FB C3                  739 	clr	c
   00FC E4                  740 	clr	a
   00FD 9A                  741 	subb	a,r2
   00FE E4                  742 	clr	a
   00FF 9B                  743 	subb	a,r3
   0100 74 01               744 	mov	a,#0x01
   0102 9C                  745 	subb	a,r4
   0103 E4                  746 	clr	a
   0104 64 80               747 	xrl	a,#0x80
   0106 8D F0               748 	mov	b,r5
   0108 63 F0 80            749 	xrl	b,#0x80
   010B 95 F0               750 	subb	a,b
   010D 40 1B               751 	jc	00108$
   010F 8E 82               752 	mov	dpl,r6
   0111 8F 83               753 	mov	dph,r7
   0113 74 7A               754 	mov	a,#0x7A
   0115 F0                  755 	movx	@dptr,a
   0116 A3                  756 	inc	dptr
   0117 AE 82               757 	mov	r6,dpl
   0119 AF 83               758 	mov	r7,dph
   011B 0A                  759 	inc	r2
   011C BA 00 09            760 	cjne	r2,#0x00,00137$
   011F 0B                  761 	inc	r3
   0120 BB 00 05            762 	cjne	r3,#0x00,00137$
   0123 0C                  763 	inc	r4
   0124 BC 00 D4            764 	cjne	r4,#0x00,00105$
   0127 0D                  765 	inc	r5
   0128                     766 00137$:
   0128 80 D1               767 	sjmp	00105$
   012A                     768 00108$:
                            769 ;	fifo_clear.c:113: for(dest = 0x3000;dest <= 0x3fff;dest++) *dest = (unsigned char) 0xaa;
   012A 7E 00               770 	mov	r6,#0x00
   012C 7F 30               771 	mov	r7,#0x30
   012E                     772 00109$:
   012E 8E 04               773 	mov	ar4,r6
   0130 8F 05               774 	mov	ar5,r7
   0132 C3                  775 	clr	c
   0133 74 FF               776 	mov	a,#0xFF
   0135 9C                  777 	subb	a,r4
   0136 74 3F               778 	mov	a,#0x3F
   0138 9D                  779 	subb	a,r5
   0139 40 0E               780 	jc	00112$
   013B 8E 82               781 	mov	dpl,r6
   013D 8F 83               782 	mov	dph,r7
   013F 74 AA               783 	mov	a,#0xAA
   0141 F0                  784 	movx	@dptr,a
   0142 A3                  785 	inc	dptr
   0143 AE 82               786 	mov	r6,dpl
   0145 AF 83               787 	mov	r7,dph
   0147 80 E5               788 	sjmp	00109$
   0149                     789 00112$:
                            790 ;	fifo_clear.c:116: for(src = 0xf000,dest = 0x3000;(int)dest <= 0x3fff;dest++,src++)
   0149 7E 00               791 	mov	r6,#0x00
   014B 7F 30               792 	mov	r7,#0x30
   014D 7C 00               793 	mov	r4,#0x00
   014F 7D F0               794 	mov	r5,#0xF0
   0151                     795 00113$:
   0151 8E 02               796 	mov	ar2,r6
   0153 8F 03               797 	mov	ar3,r7
   0155 C3                  798 	clr	c
   0156 74 FF               799 	mov	a,#0xFF
   0158 9A                  800 	subb	a,r2
   0159 74 BF               801 	mov	a,#(0x3F ^ 0x80)
   015B 8B F0               802 	mov	b,r3
   015D 63 F0 80            803 	xrl	b,#0x80
   0160 95 F0               804 	subb	a,b
   0162 40 18               805 	jc	00118$
                            806 ;	fifo_clear.c:117: *dest = *src;
   0164 8C 82               807 	mov	dpl,r4
   0166 8D 83               808 	mov	dph,r5
   0168 E0                  809 	movx	a,@dptr
   0169 FB                  810 	mov	r3,a
   016A A3                  811 	inc	dptr
   016B AC 82               812 	mov	r4,dpl
   016D AD 83               813 	mov	r5,dph
   016F 8E 82               814 	mov	dpl,r6
   0171 8F 83               815 	mov	dph,r7
   0173 EB                  816 	mov	a,r3
   0174 F0                  817 	movx	@dptr,a
   0175 A3                  818 	inc	dptr
   0176 AE 82               819 	mov	r6,dpl
   0178 AF 83               820 	mov	r7,dph
                            821 ;	fifo_clear.c:116: for(src = 0xf000,dest = 0x3000;(int)dest <= 0x3fff;dest++,src++)
   017A 80 D5               822 	sjmp	00113$
   017C                     823 00118$:
   017C 80 FE               824 	sjmp	00118$
                            825 	.area CSEG    (CODE)
                            826 	.area CONST   (CODE)
                            827 	.area XINIT   (CODE)
