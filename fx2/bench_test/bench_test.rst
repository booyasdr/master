                              ...
                              4 ; This file was generated Wed May 21 07:32:16 2014
                              5 ;--------------------------------------------------------
                              6 	.module bench_test
   ...
   0006 80 FE               584 	sjmp .
                            ...
                            591 ;------------------------------------------------------------
                            592 ;	bench_test.c:39: static void Initialize(void)
                            593 ;	-----------------------------------------
   ...
   0064                     596 _Initialize:
                    ...
                    0001    603 	ar1 = 0x01
                    0000    604 	ar0 = 0x00
                            605 ;	bench_test.c:42: CPUCS = 0x0a;  // 24MHz, output to CLKOUT signal enabled.
   0064 90 E6 00            606 	mov	dptr,#_CPUCS
   0067 74 0A               607 	mov	a,#0x0A
   0069 F0                  608 	movx	@dptr,a
                            609 ;	bench_test.c:47: IFCONFIG = 0x43;
   006A 90 E6 01            610 	mov	dptr,#_IFCONFIG
   006D 74 43               611 	mov	a,#0x43
   006F F0                  612 	movx	@dptr,a
                            613 ;	bench_test.c:48: SYNCDELAY;
   0070 00                  614 	nop 
   0071 00                  615 	nop 
   0072 00                  616 	nop 
   0073 00                  617 	nop 
                            618 ;	bench_test.c:50: IFCONFIG = 0x53;
   0074 90 E6 01            619 	mov	dptr,#_IFCONFIG
   0077 74 53               620 	mov	a,#0x53
   0079 F0                  621 	movx	@dptr,a
                            622 ;	bench_test.c:51: SYNCDELAY;
   007A 00                  623 	nop 
   007B 00                  624 	nop 
   007C 00                  625 	nop 
   007D 00                  626 	nop 
                            627 ;	bench_test.c:53: IFCONFIG = 0xc3;
   007E 90 E6 01            628 	mov	dptr,#_IFCONFIG
   0081 74 C3               629 	mov	a,#0xC3
   0083 F0                  630 	movx	@dptr,a
                            631 ;	bench_test.c:54: SYNCDELAY;
   0084 00                  632 	nop 
   0085 00                  633 	nop 
   0086 00                  634 	nop 
   0087 00                  635 	nop 
                            636 ;	bench_test.c:55: REVCTL = 0x03;   // See TRM...
   0088 90 E6 0B            637 	mov	dptr,#_REVCTL
   008B 74 03               638 	mov	a,#0x03
   008D F0                  639 	movx	@dptr,a
                            640 ;	bench_test.c:56: SYNCDELAY;
   008E 00                  641 	nop 
   008F 00                  642 	nop 
   0090 00                  643 	nop 
   0091 00                  644 	nop 
                            645 ;	bench_test.c:59: EP6CFG = 0xe0;
   0092 90 E6 14            646 	mov	dptr,#_EP6CFG
   0095 74 E0               647 	mov	a,#0xE0
   0097 F0                  648 	movx	@dptr,a
                            649 ;	bench_test.c:60: SYNCDELAY;
   0098 00                  650 	nop 
   0099 00                  651 	nop 
   009A 00                  652 	nop 
   009B 00                  653 	nop 
                            654 ;	bench_test.c:62: FIFORESET = 0x80;  SYNCDELAY;  // NAK all requests from host.
   009C 90 E6 04            655 	mov	dptr,#_FIFORESET
   009F 74 80               656 	mov	a,#0x80
   00A1 F0                  657 	movx	@dptr,a
   00A2 00                  658 	nop 
   00A3 00                  659 	nop 
   00A4 00                  660 	nop 
   00A5 00                  661 	nop 
                            662 ;	bench_test.c:63: FIFORESET = 0x82;  SYNCDELAY;  // Reset individual EP (2,4,6,8)
   00A6 90 E6 04            663 	mov	dptr,#_FIFORESET
   00A9 74 82               664 	mov	a,#0x82
   00AB F0                  665 	movx	@dptr,a
   00AC 00                  666 	nop 
   00AD 00                  667 	nop 
   00AE 00                  668 	nop 
   00AF 00                  669 	nop 
                            670 ;	bench_test.c:64: FIFORESET = 0x84;  SYNCDELAY;
   00B0 90 E6 04            671 	mov	dptr,#_FIFORESET
   00B3 74 84               672 	mov	a,#0x84
   00B5 F0                  673 	movx	@dptr,a
   00B6 00                  674 	nop 
   00B7 00                  675 	nop 
   00B8 00                  676 	nop 
   00B9 00                  677 	nop 
                            678 ;	bench_test.c:65: FIFORESET = 0x86;  SYNCDELAY;
   00BA 90 E6 04            679 	mov	dptr,#_FIFORESET
   00BD 74 86               680 	mov	a,#0x86
   00BF F0                  681 	movx	@dptr,a
   00C0 00                  682 	nop 
   00C1 00                  683 	nop 
   00C2 00                  684 	nop 
   00C3 00                  685 	nop 
                            686 ;	bench_test.c:66: FIFORESET = 0x88;  SYNCDELAY;
   00C4 90 E6 04            687 	mov	dptr,#_FIFORESET
   00C7 74 88               688 	mov	a,#0x88
   00C9 F0                  689 	movx	@dptr,a
   00CA 00                  690 	nop 
   00CB 00                  691 	nop 
   00CC 00                  692 	nop 
   00CD 00                  693 	nop 
                            694 ;	bench_test.c:67: FIFORESET = 0x00;  SYNCDELAY;  // Resume normal operation.
   00CE 90 E6 04            695 	mov	dptr,#_FIFORESET
   00D1 E4                  696 	clr	a
   00D2 F0                  697 	movx	@dptr,a
   00D3 00                  698 	nop 
   00D4 00                  699 	nop 
   00D5 00                  700 	nop 
   00D6 00                  701 	nop 
                            702 ;	bench_test.c:70: EP6FIFOCFG = 0x0d;
   00D7 90 E6 1A            703 	mov	dptr,#_EP6FIFOCFG
   00DA 74 0D               704 	mov	a,#0x0D
   00DC F0                  705 	movx	@dptr,a
                            706 ;	bench_test.c:71: SYNCDELAY;
   00DD 00                  707 	nop 
   00DE 00                  708 	nop 
   00DF 00                  709 	nop 
   00E0 00                  710 	nop 
                            711 ;	bench_test.c:74: PORTACFG = 0x00;
   00E1 90 E6 70            712 	mov	dptr,#_PORTACFG
   00E4 E4                  713 	clr	a
   00E5 F0                  714 	movx	@dptr,a
                            715 ;	bench_test.c:75: SYNCDELAY; // maybe not needed
   00E6 00                  716 	nop 
   00E7 00                  717 	nop 
   00E8 00                  718 	nop 
   00E9 00                  719 	nop 
                            720 ;	bench_test.c:78: FIFOPINPOLAR=0x00;
   00EA 90 E6 09            721 	mov	dptr,#_FIFOPINPOLAR
   00ED E4                  722 	clr	a
   00EE F0                  723 	movx	@dptr,a
                            724 ;	bench_test.c:79: SYNCDELAY;
   00EF 00                  725 	nop 
   00F0 00                  726 	nop 
   00F1 00                  727 	nop 
   00F2 00                  728 	nop 
                            729 ;	bench_test.c:83: EP6AUTOINLENH = 0x02; // MSB
   00F3 90 E6 24            730 	mov	dptr,#_EP6AUTOINLENH
   00F6 74 02               731 	mov	a,#0x02
   00F8 F0                  732 	movx	@dptr,a
                            733 ;	bench_test.c:84: SYNCDELAY;
   00F9 00                  734 	nop 
   00FA 00                  735 	nop 
   00FB 00                  736 	nop 
   00FC 00                  737 	nop 
                            738 ;	bench_test.c:85: EP6AUTOINLENL = 0x00; // LSB
   00FD 90 E6 25            739 	mov	dptr,#_EP6AUTOINLENL
   0100 E4                  740 	clr	a
   0101 F0                  741 	movx	@dptr,a
                            742 ;	bench_test.c:86: SYNCDELAY;
   0102 00                  743 	nop 
   0103 00                  744 	nop 
   0104 00                  745 	nop 
   0105 00                  746 	nop 
   0106 22                  747 	ret
                            ...
                            750 ;------------------------------------------------------------
                            751 ;	bench_test.c:90: void main()
                            752 ;	-----------------------------------------
                            753 ;	 function main
                            754 ;	-----------------------------------------
   0107                     755 _main:
                            756 ;	bench_test.c:92: Initialize();
   0107 12 00 64            757 	lcall	_Initialize
   010A                     758 00102$:
   010A 80 FE               759 	sjmp	00102$
                            760 	.area CSEG    (CODE)
                            761 	.area CONST   (CODE)
                            762 	.area XINIT   (CODE)
