...
{
		xdata unsigned char *src=0xE000;
		xdata unsigned char *dest=0x2000;
...
//	EP6AUTOINLENL = 0x00; // LSB
   ...
   for(src=0xf000;(int)src < 0xf100;src++)  *src = 0xc0;
    for(src=0xf000,dest = 0x1000;(int)dest < 0x1000;src++,dest++) *dest = *src;
